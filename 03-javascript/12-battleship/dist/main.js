...
/* harmony export */ });
/* harmony import */ var _logic_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logic/types */ "./src/logic/types.js");
  ...
  grid(grid, left, onClick) {
    ...
    for (let i = 0; i < grid.length; i++) {
      ...
      for (let j = 0; j < grid[0].length; j++) {
        ...
        if (!left) {
          square.onclick = () => onClick((0,_logic_types__WEBPACK_IMPORTED_MODULE_0__.Coords)(j, i));
...
/* harmony import */ var _display_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../display/renderer */ "./src/display/renderer.js");



class Game {
  user = new _player__WEBPACK_IMPORTED_MODULE_0__["default"](false, true);
  computer = new _player__WEBPACK_IMPORTED_MODULE_0__["default"](true, true);
  renderer = new _display_renderer__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  resetState() {
    this.user = new _player__WEBPACK_IMPORTED_MODULE_0__["default"](false, true);
    this.computer = new _player__WEBPACK_IMPORTED_MODULE_0__["default"](true, true);
...
class GameBoard {
  ...
  place(start, end) {
    ...
    this.ships.set(
      this.#nextShipId,
      new _ship__WEBPACK_IMPORTED_MODULE_0__["default"](Math.max(end.x - start.x, end.y - start.y) + 1),
    );
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./src/logic/types.js");
...
class Player {
  ...
  getAttack() {
    ...
    return (0,_types__WEBPACK_IMPORTED_MODULE_1__.Coords)(coords[0], coords[1]);
  }
  ...
  #getCoordPairOfSize(size) {
    ...
    if (horizontal) {
      return [(0,_types__WEBPACK_IMPORTED_MODULE_1__.Coords)(b, a), (0,_types__WEBPACK_IMPORTED_MODULE_1__.Coords)(b, a + size - 1)];
    } else {
      return [(0,_types__WEBPACK_IMPORTED_MODULE_1__.Coords)(a, b), (0,_types__WEBPACK_IMPORTED_MODULE_1__.Coords)(a + size - 1, b)];
    }
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Coords: () => (/* binding */ createCoords),
...
const game = new _logic_game__WEBPACK_IMPORTED_MODULE_0__["default"]();
game.run();
